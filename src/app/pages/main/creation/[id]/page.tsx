    ...
    return (
        <div className='py-[80px] flex flex-col items-center md:flex-row md:justify-center md:items-start  gap-5'>
            <div className='w-[250px] h-[400px] bg-blue relative bg-card rounded-xl flex justify-center items-center'>
                <Input type="file" id="picture" className='hidden' ref={fileInputRef} onChange={handleFileChange} />
                <UploadIcon className='w-1/5 h-1/5 text-gray-500 hover:cursor-pointer' onClick={handleImageClick} />
            ...
            <div className="flex flex-col gap-5">
                <div className='flex flex-col gap-5 bg-card p-5 sm:min-w-[400px] md:min-w-[500px] rounded-xl'>
                    ...
                    <div className='flex flex-col gap-1'>
                        ...
                        <Textarea placeholder="Your Story Description" className='min-h-[300px] md:min-h-[200px]' />
                    </div>
                ...
                <div className='flex gap-3 justify-center md:justify-start'>
                    ...
                    <Button className='w-[80px] bg-red-500 hover:scale-105 hover:bg-red-500 text-foreground'>Cancel</Button>
                    <Button className='w-[80px] bg-rainbow text-foreground hover:scale-105'>
                        <a href='/pages/main/write/123'>Continue</a>
                    </Button>
                </div>
            </div>
        </div>
