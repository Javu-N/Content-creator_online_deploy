    ...
    return (
        <div className='flex flex-col justify-center items-center'>
                        ...
                        <ScrollArea className="h-72 min-w-[200px] md:min-w-[300px] max-w-[300px] md:max-w-[400px]rounded-md border bg-card m-0">
                            <div className="flex flex-col">
                                {chapters.map((chapter) => (
                                    <div key={chapter.id} className='border-b-1 pt-4 pb-2 hover:opacity-10 hover:cursor-pointer'>
            ...
            <div className='mt-[220px] mb-[50px] bg-card flex flex-col items-center p-5 md:min-w-[600px] lg:min-w-[800px] xl:min-w-[1000px] rounded-xl gap-3'>
                <input type='text' placeholder='Enter Chapter title' className='text-2xl py-2 px-5 rounded-md w-full' />
                ...
                <Button onClick={addTextarea} className='w-[150px]'>New Paragraph</Button>
