            ...
            <section className="min-h-screen flex items-center justify-center">
                <div className="bg-card flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
                    ...
                    <div className="md:w-1/2 px-8 md:px-16">
                        ...
                        <p className="text-xs mt-4 text-foreground">If you are already a member, easily log in</p>
                        ...
                        <div className="mt-3 text-xs flex justify-between items-center text-foreground">
                            ...
                            <button className="py-2 px-5 bg-rainbow rounded-xl hover:scale-110 duration-300 font-bold">Register</button>
                        </div>
                    </div>
                    ...
                    <div className="md:block hidden w-1/2 relative">
                        {
                            randomQuote.length > 100 ? (
                                <Image className="rounded-2xl h-[600px] opacity-40" src={vn_sample_image} alt="Login Image" />
                            ) : (
                                <Image className="rounded-2xl h-[600px] opacity-40" src={sample_image} alt="Login Image" />
                            )
                        }

                        <div className="absolute top-2/3 text-foreground ml-[70px] mr-[30px] text-right">
                            <p className="italic font-bold">&quot;{randomQuote.length > 100 ? 'Nothing is more important than independence and freedom' : randomQuote.quote}&quot;</p>
                            <p className="mt-2">-{randomQuote.length > 100 ? 'Ho Chi Minh' : randomQuote.author}</p>
                        </div>
                    </div>
                </div>
            </section>
