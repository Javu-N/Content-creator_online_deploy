          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 lg:w-2/3">
              ...
              <div className="flex gap-3">
                <a
                  href="#"
                  className="bg-rainbow hover:scale-110 duration-300 text-foreground font-bold py-3 px-6 rounded-md"
                >
                  {`Let's read`}
                </a>
                <Link
                  href="/pages/main/creation/123"
                  className="bg-[#002D74] hover:scale-110 duration-300 text-foreground font-bold py-3 px-6 rounded-md"
                >
                  Create Yours
                </Link>
              </div>
